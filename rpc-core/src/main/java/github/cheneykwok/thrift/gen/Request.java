      ...
      if (struct.parameters != null) {
        if (struct.isSetParameters()) {
          oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
          {
            ...
            for (String _iter6 : struct.parameters)
            {
      ...
      if (struct.parameterTypes != null) {
        if (struct.isSetParameterTypes()) {
          oprot.writeFieldBegin(PARAMETER_TYPES_FIELD_DESC);
          {
            ...
            for (String _iter7 : struct.parameterTypes)
            {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (String _iter8 : struct.parameters)
          {
      ...
      if (struct.isSetParameterTypes()) {
        {
          ...
          for (String _iter9 : struct.parameterTypes)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.parameters = new java.util.ArrayList<String>(_list10.size);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.parameterTypes = new java.util.ArrayList<String>(_list13.size);
