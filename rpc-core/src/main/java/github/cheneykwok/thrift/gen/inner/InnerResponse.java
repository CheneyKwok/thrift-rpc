...
public class InnerResponse implements org.apache.thrift.TBase<InnerResponse, InnerResponse._Fields>, java.io.Serializable, Cloneable, Comparable<InnerResponse> {
  ...
  public InnerResponse setMessage(@org.apache.thrift.annotation.Nullable String message) {
    this.message = message;
    return this;
  }
  ...
  public InnerResponse setData(@org.apache.thrift.annotation.Nullable String data) {
    this.data = data;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InnerResponse(");
    boolean first = true;
