...
public class Request implements org.apache.thrift.TBase<Request, Request._Fields>, java.io.Serializable, Cloneable, Comparable<Request> {
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String classCanonicalName; // required
  ...
  public Request(
    java.lang.String classCanonicalName,
  ...
  public Request setClassCanonicalName(@org.apache.thrift.annotation.Nullable java.lang.String classCanonicalName) {
    this.classCanonicalName = classCanonicalName;
    return this;
  }
  ...
  public Request setHeader(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> header) {
    this.header = header;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case CLASS_CANONICAL_NAME:
      if (value == null) {
        ...
        setClassCanonicalName((java.lang.String)value);
      }
      break;
  ...
  public int compareTo(Request other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetClassCanonicalName(), other.isSetClassCanonicalName());
    if (lastComparison != 0) {
      ...
      if (struct.parameters != null) {
        if (struct.isSetParameters()) {
          oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter10 : struct.parameters)
            {
      ...
      if (struct.parameterTypes != null) {
        if (struct.isSetParameterTypes()) {
          oprot.writeFieldBegin(PARAMETER_TYPES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter11 : struct.parameterTypes)
            {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (java.lang.String _iter13 : struct.parameters)
          {
      ...
      if (struct.isSetParameterTypes()) {
        {
          ...
          for (java.lang.String _iter14 : struct.parameterTypes)
          {
      ...
      if (struct.isSetHeader()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter15 : struct.header.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.parameters = new java.util.ArrayList<java.lang.String>(_list16.size);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.parameterTypes = new java.util.ArrayList<java.lang.String>(_list19.size);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.header = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map22.size);
